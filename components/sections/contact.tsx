          ...
          <div className="grid grid-cols-2 gap-14 items-start max-[720px]:grid-cols-1 max-[720px]:gap-6">
            <FadeIn>
              <div>
                ...
                <h2 className="text-[clamp(36px,6vw,64px)] font-semibold tracking-[-0.02em] leading-[1.05] mt-3">
                  let&apos;s build
                  <br />
                  something.
                </h2>
            ...
            <FadeIn delay={100}>
              <div className="flex flex-col gap-px bg-border border border-border rounded-[10px] overflow-hidden">
