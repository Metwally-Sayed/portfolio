  ...
  experience: [
    {
      ...
      roleAr: "مهندس واجهات أمامية أول",
    ...
    },
    {
      ...
      locationAr: "عن بُعد، أونتاريو، كندا",
      ...
      points: [
        ...
        "Collaborated with remote product and backend teams to resolve bugs and improve usability.",
      ],
      pointsAr: [
        ...
        "تعاونت مع فرق المنتج والباك إند عن بُعد لحل المشاكل وتحسين قابلية الاستخدام.",
      ],
    },
  ],
  skills: [
